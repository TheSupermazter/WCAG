document.addEventListener('DOMContentLoaded', () => {
    ...
    const imageDescriptions = {
        ...
        "1.2.1": "Als je audio of video gebruikt, zorg dan voor een transcript of tekstalternatief.",
        "1.2.2": "Zorg dat je ondertiteling toevoegt aan alle video's met audio.",
        "1.2.3": "Zorg dat je audiodescriptie of een alternatief biedt voor video content zonder audio.",
        "1.3.1": "Gebruik semantische HTML voor koppen, lijsten en tabellen zodat relaties duidelijk zijn voor iedereen.",
        "1.3.2": "Presenteer content in een logische leesvolgorde, zodat schermlezers de juiste volgorde aanhouden.",
        "1.3.3": "Geef instructies die niet alleen afhankelijk zijn van kleur, vorm of locatie. Bijvoorbeeld: 'Klik op de knop met het label Verzenden'.",
        "1.3.4": "Sta toe dat de gebruiker de schermoriëntatie (portret/landschap) zelf bepaalt.",
        "1.3.5": "Gebruik autocomplete-attributen voor invoervelden zodat browsers het doel herkennen (zoals naam, e-mail).",
        "1.4.1": "Gebruik niet alleen kleur om betekenis over te brengen. Voeg bijvoorbeeld een icoon of tekst toe bij foutmeldingen.",
        "1.4.2": "Zorg dat automatisch afspelende audio langer dan 3 seconden gepauzeerd of gestopt kan worden.",
        "2.1.1": "Zorg dat alle functionaliteit volledig bedienbaar is met het toetsenbord.",
        "2.1.2": "Zorg dat gebruikers niet vast komen te zitten in een interactief element met het toetsenbord.",
        "2.1.4": "Zorg dat gebruikers sneltoetsen met één toets kunnen uitschakelen of herdefiniëren.",
        "2.2.1": "Als je tijdslimieten gebruikt, zorg dan dat gebruikers deze kunnen verlengen of uitschakelen.",
        "2.2.2": "Zorg dat gebruikers bewegende, knipperende of scrollende content kunnen pauzeren, stoppen of verbergen.",
        "2.3.1": "Zorg dat geen enkele content meer dan 3 keer per seconde flits (om epileptische aanvallen te voorkomen).",
        "2.4.1": "Zorg dat je een mechanisme biedt om herhaalde blokken content over te slaan (bijv. navigatiemenu's).",
        "2.4.2": "Zorg dat elke pagina een beschrijvende, unieke titel heeft.",
        "2.4.3": "Zorg dat de focusvolgorde een logische, voorspelbare sequentie volgt.",
        "2.4.4": "Maak linkteksten beschrijvend, bijvoorbeeld 'Bekijk onze diensten' in plaats van 'Klik hier'.",
        "2.5.1": "Vermijd complexe gebaren zoals swipen of knijpen, tenzij er een eenvoudig alternatief is.",
        "2.5.2": "Acties mogen pas worden uitgevoerd bij het loslaten van een knop of aanraking, niet bij het indrukken.",
        "2.5.3": "Zorg dat het zichtbare label van een knop ook in de toegankelijke naam voorkomt.",
        "2.5.4": "Bied alternatieven voor functies die door beweging (zoals schudden) worden geactiveerd.",
        "3.1.1": "Stel de hoofdtaal van de pagina in met het lang-attribuut op het <html>-element.",
        "3.2.1": "Laat het veranderen van context (zoals navigeren) niet automatisch gebeuren bij focus.",
        "3.2.2": "Laat het veranderen van context niet automatisch gebeuren bij het invullen van een veld.",
        "3.3.1": "Geef duidelijke foutmeldingen bij invoerfouten, bijvoorbeeld 'Vul een geldig e-mailadres in'.",
        "3.3.2": "Voorzie alle formuliervelden van duidelijke labels of instructies.",
        "4.1.1": "Gebruik geldige HTML en zorg dat elementen correct genest zijn.",
        "4.1.2": "Zorg dat interactieve elementen hun naam, rol en waarde communiceren aan ondersteunende technologie.",
        "4.1.3": "Statusberichten (zoals 'opgeslagen!') moeten door schermlezers worden aangekondigd.",
        "1.2.4": "Voorzie live video van ondertiteling, bijvoorbeeld bij livestreams.",
        "1.2.5": "Voeg audiodescriptie toe aan vooraf opgenomen video's met gesproken tekst.",
        "1.3.6": "Identificeer het doel van invoervelden en iconen programmatisch voor personalisatie.",
        "1.4.3": "Zorg voor voldoende contrast tussen tekst en achtergrond (minimaal 4.5:1 voor gewone tekst).",
        "1.4.4": "Tekst moet tot 200% vergroot kunnen worden zonder verlies van content of functionaliteit.",
        "1.4.5": "Gebruik echte tekst in plaats van afbeeldingen van tekst, tenzij strikt noodzakelijk.",
        "1.4.10": "Zorg dat content zich aanpast (reflow) bij vergroten tot 400% zonder horizontaal scrollen.",
        "1.4.11": "Zorg voor voldoende contrast tussen niet-tekstuele elementen (zoals knoppen en iconen) en de achtergrond.",
        "1.4.12": "Content moet bruikbaar blijven als gebruikers tekstafstand (regel- en letterafstand) aanpassen.",
        "1.4.13": "Informatie die verschijnt bij hover of focus moet makkelijk te verbergen zijn en niet verdwijnen als je erover beweegt.",
        "2.4.5": "Bied meerdere manieren om een pagina te vinden, zoals een zoekfunctie, sitemap of menu.",
        "2.4.6": "Gebruik duidelijke koppen en labels zodat gebruikers snel begrijpen waar content over gaat.",
        "2.4.7": "Zorg dat het toetsenbordfocus zichtbaar is, bijvoorbeeld door een duidelijke rand.",
        "2.5.5": "Interactieve doelen (zoals knoppen) moeten minimaal 24x24 CSS-pixels groot zijn.",
        "2.5.6": "Sta meerdere invoermethoden toe, zoals toetsenbord, muis en touch.",
        "3.1.2": "Geef aan als delen van de pagina in een andere taal zijn, bijvoorbeeld met lang-attributen.",
        "3.2.3": "Zorg dat navigatie op elke pagina consistent is opgebouwd.",
        "3.2.4": "Gebruik voor gelijksoortige knoppen en functies steeds dezelfde naam en vormgeving.",
        "3.3.3": "Geef waar mogelijk suggesties om invoerfouten te corrigeren.",
        "3.3.4": "Laat gebruikers belangrijke gegevens controleren, corrigeren en bevestigen voordat ze definitief worden verzonden.",
        "3.3.7": "Vraag gebruikers niet om dezelfde informatie meerdere keren in te vullen.",
        "3.3.8": "Authenticatie mag niet alleen afhankelijk zijn van cognitieve tests, bied alternatieven zoals wachtwoordmanagers.",
        "1.2.6": "Voorzie vooraf opgenomen video van gebarentaalvertaling.",
        "1.2.7": "Bied uitgebreide audiodescriptie als pauzes in de video niet voldoende zijn.",
        "1.2.8": "Voorzie een volledig tekstalternatief voor vooraf opgenomen gesynchroniseerde media.",
        "1.2.9": "Voorzie live audio-only van een transcript of gelijkwaardig alternatief.",
        "1.3.7": "Bied een optie om animaties of bewegingen te verminderen voor gevoelige gebruikers.",
        "1.4.6": "Zorg voor extra hoog contrast (minimaal 7:1) voor tekst en afbeeldingen van tekst.",
        "1.4.7": "Achtergrondgeluid mag niet storend zijn: maak het zacht, uitzetbaar of minstens 20 dB zachter dan spraak.",
        "1.4.8": "Laat gebruikers de visuele presentatie aanpassen, zoals kleuren, lettertype en afstand.",
        "1.4.9": "Gebruik helemaal geen afbeeldingen van tekst, ook niet als uitzondering.",
        "2.1.3": "Alle functionaliteit moet zonder uitzondering met het toetsenbord te bedienen zijn.",
        "2.2.3": "Er mogen geen tijdslimieten zijn voor het voltooien van taken, tenzij essentieel.",
        "2.2.4": "Laat gebruikers onderbrekingen (zoals pop-ups) uitstellen of onderdrukken.",
        "2.2.5": "Laat gebruikers na herauthenticatie verdergaan zonder gegevensverlies.",
        "2.2.6": "Waarschuw gebruikers voor time-outs door inactiviteit die tot gegevensverlies leiden.",
        "2.3.2": "Geen enkele content mag meer dan 3 keer per seconde flitsen, ook niet op hogere niveaus.",
        "2.3.3": "Laat gebruikers animaties die door interacties ontstaan uitschakelen.",
        "2.4.8": "Geef aan waar de gebruiker zich bevindt op de website, bijvoorbeeld met kruimelpaden.",
        "2.4.9": "Het doel van elke link moet duidelijk zijn uit de linktekst alleen.",
        "2.4.10": "Gebruik sectiekoppen om alle content logisch te structureren.",
        "2.4.11": "De focusindicator moet extra goed zichtbaar zijn en voldoen aan contrast-eisen.",
        "2.5.7": "Bied alternatieven voor acties die slepen vereisen, zoals knoppen om te verplaatsen.",
        "2.5.8": "Interactieve doelen moeten minimaal 24x24 CSS-pixels zijn, met beperkte uitzonderingen.",
        "3.1.3": "Leg ongebruikelijke of technische termen uit, bijvoorbeeld met een tooltip of woordenlijst.",
        "3.1.4": "Schrijf afkortingen voluit of geef de betekenis bij eerste gebruik.",
        "3.1.5": "Schrijf teksten op een eenvoudig leesniveau, maximaal onderbouw-niveau.",
        "3.1.6": "Geef uitspraak-informatie als de betekenis van een woord afhangt van de uitspraak.",
        "3.2.5": "Laat contextwijzigingen alleen plaatsvinden als de gebruiker hierom vraagt.",
        "3.3.5": "Bied hulp aan, zoals uitleg, veelgestelde vragen of contactmogelijkheden.",
        "3.3.6": "Laat gebruikers altijd hun invoer controleren, corrigeren en bevestigen voor verzending."
    };
