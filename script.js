document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('content.json')
        ...
        .then(json => {
            // FIX: Access the correct language data from the JSON
            const languageData = json[currentLanguage] || json['nl']; // fallback to nl if current language not found
            
            checklistItems = {
                levelA: languageData.levelA,
                levelAA: languageData.levelAA,
                levelAAA: languageData.levelAAA
            };
    ...
    const updateProgressBars = () => {
        ...
        levels.forEach(level => {
            const totalItems = checklistItems[`level${level.toUpperCase()}`]?.length || 0;
    ...
    const itemTypeMap = {
        // Level A
        "1.1.1": "D", "1.2.1": "C", "1.2.2": "C", "1.2.3": "C",
        "1.3.1": "D", "1.3.2": "D", "1.3.3": "D", "1.3.4": "D", "1.3.5": "D",
        "1.4.1": "D", "1.4.2": "D",
        "2.1.1": "D", "2.1.2": "D", "2.1.4": "D",
        "2.2.1": "D", "2.2.2": "D",
        "2.3.1": "C",
        "2.4.1": "D", "2.4.2": "D", "2.4.3": "D", "2.4.4": "D",
        "2.5.1": "D", "2.5.2": "D", "2.5.3": "D", "2.5.4": "D",
        "3.1.1": "D", "3.2.1": "D", "3.2.2": "D",
        "3.3.1": "D", "3.3.2": "D",
        "4.1.1": "D", "4.1.2": "D", "4.1.3": "D",
        // Level AA
        "1.2.4": "C", "1.2.5": "C", "1.3.6": "D", "1.4.3": "D", "1.4.4": "D", "1.4.5": "D", "1.4.10": "D", "1.4.11": "D", "1.4.12": "D", "1.4.13": "D",
        "2.4.5": "D", "2.4.6": "D", "2.4.7": "D", "2.5.5": "D", "2.5.6": "D",
        "3.1.2": "D", "3.2.3": "D", "3.2.4": "D", "3.3.3": "D", "3.3.4": "D", "3.3.7": "D", "3.3.8": "D",
        // Level AAA
        "1.2.6": "C", "1.2.7": "C", "1.2.8": "C", "1.2.9": "C", "1.3.7": "D", "1.4.6": "D", "1.4.7": "D", "1.4.8": "D", "1.4.9": "D",
        "2.1.3": "D", "2.2.3": "D", "2.2.4": "D", "2.2.5": "D", "2.2.6": "D", "2.3.2": "C", "2.3.3": "D",
        "2.4.8": "D", "2.4.9": "D", "2.4.10": "D", "2.4.11": "D", "2.5.7": "D", "2.5.8": "D",
        "3.1.3": "C", "3.1.4": "C", "3.1.5": "C", "3.1.6": "C", "3.2.5": "D", "3.3.5": "C", "3.3.6": "D"
    };
    ...
    const createChecklist = (level, items) => {
        ...
        if (!items || !Array.isArray(items)) {
            console.error(`No items found for level: ${level}`, items);
            return;
        }
        ...
        items.forEach(item => {
            ...
            li.addEventListener('click', (e) => {
                if (!e.target.closest('.info-button') && e.target !== image) {
                    ...
                    savedState[item.id] = { ...savedState[item.id], checked: checkbox.checked };
            ...
            infoButton.addEventListener('click', (e) => {
                ...
                savedState[item.id] = { ...savedState[item.id], expanded: isExpanded };
                localStorage.setItem('wcagChecklistState', JSON.stringify(savedState));
            });
    ...
    const toggleLanguage = () => {
        ...
        // FIX: Reload the content for the new language
        fetch('content.json')
            .then(response => response.json())
            .then(json => {
                const languageData = json[currentLanguage] || json['nl'];
                checklistItems = {
                    levelA: languageData.levelA,
                    levelAA: languageData.levelAA,
                    levelAAA: languageData.levelAAA
        ...
        // Setup the progress text toggle after initial render
        setTimeout(() => {
    ...
    function setupProgressTextCategoryToggle() {
        ...
        categories.forEach(cat => {
            ...
            if (barEl) {
                cat.wrapper = barEl.parentElement;
            }
        });
